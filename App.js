    ...
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View ref={aboutMeRef}>
        ...
        <View style={styles.contentContainer}>
          ...
          <Image style={styles.image} source={{ uri: 'https://i.imgur.com/1PCZi4E.jpeg' }} />
      ...
      <View ref={galleryRef}>
        ...
        <View style={styles.galleryContainer}>
          <ScrollView horizontal={true} contentContainerStyle={styles.gallery}>
            ...
            <Image style={styles.galleryImage} source={{ uri: 'https://i.imgur.com/GpaZxGO.png' }} />
            <Image style={styles.galleryImage} source={{ uri: 'https://i.imgur.com/YfdJ2vX.png' }} />
            <Image style={styles.galleryImage} source={{ uri: 'https://i.imgur.com/8Psir7m.png' }} />
            <Image style={styles.galleryImage} source={{ uri: 'https://i.imgur.com/GT3DrdL.png' }} />
